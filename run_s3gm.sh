# For KSE
# CUDA_VISIBLE_DEVICES=0 python train.py --data kse --version vx --dims 1 --epochs 300 --batch_size 50 --train_split 0.9 --num_components 1 --num_conditions 1 --attn_resolutions 16 --ch_mult 1 2 4 8 --data_location ./data/kse/KSE_train.npy --verbose 1
